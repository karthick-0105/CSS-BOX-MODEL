...
public class Thread1 {
	public static void main(String args[]) {
		...
		if (num.isAlive()) {
		System.out.println("Gopi thread is Alive");
		} else {
			System.out.println("Gopi Thread is dead");
		}

		if (alp.isAlive()) {
		System.out.println("Sakthi thread is Alive");
		} else {
		System.out.println("Sakthi thread is dead");
		}
